...
* [STREAM-2285](https://inindca.atlassian.net/browse/STREAM-2242) - Fixes issue around rejecting a second incoming call would put the initial active call on hold
...
# [v3.0.1](https://github.com/purecloudlabs/softphone-vendor-headsets/compare/v3.0.0...v3.0.1)
## Fixed
* [STREAM-456](https://inindca.atlassian.net/browse/STREAM-456) - Fixed issue with Jabra Native implementation when Jabra WebHID feature toggle is disabled
...
## Changed
* [STREAM-456](https://inindca.atlassian.net/browse/STREAM-456) - Removed internal, antiquated value in favor of a more proper approach involving a passed in value from the consuming app. Bump TypeScript from v4 to v5.
## Added
* [STREAM-881](https://inindca.atlassian.net/browse/STREAM-881) - Generate a test report in JUnit.xml format. Added jest-junit v16.
...
# [v2.5.7](https://github.com/purecloudlabs/softphone-vendor-headsets/compare/v2.5.6...v2.5.7)
## Changed
