...
async function ma(a,b){u(a,1,"platformConnectHeadset");if(!b)v=void 0;else if("number"==typeof b)v=w(b);else if("function"!=typeof b){u(a,3,"Invalid callback type");return}a.device&&(a.device.close(),u(a,2,"Open called while a device is opened, calling close."));b=await navigator.hid.getDevices();var e=new CustomEvent("ccsdkSelectDeviceEvent",{cancelable:true,detail:{isSelectedDevice:false}});for(var c of b)if(c.dispatchEvent(e),e.detail.isSelectedDevice){a.device=c;break}if(a.device)if(1151!==a.device.vendorId&&
2397!==a.device.vendorId&&1008!==a.device.vendorId){var d=`Device vendor ID 0x${a.device.vendorId.toString(16).padStart(4,"0")} not supported`;u(a,3,d);a.device=null;v(0);}else if(await a.device.open(),a.device.opened){a.device.addEventListener("inputreport",a.C);u(a,1,a.device);a.l=null;c=0;for(d of a.device.collections){let g=true;b=a;e=`----\nDevice collection\nUsage page ${"0x"+d.usagePage.toString(16).padStart(4,"0")}\nUsage: ${"0x"+d.usage.toString(16).padStart(4,"0")}\nType: ${"0x"+d.type.toString(16).padStart(4,
"0")}`;u(b,1,e);11==d.usagePage?(c|=1,r(a,"hasTelephonyDevice")):65440==d.usagePage?(c|=16,r(a,"hasHIDLegacy")):65442==d.usagePage?(c|=2,r(a,"hasHID2")):65307==d.usagePage?(c|=4,r(a,"hasTelephonyReplicant")):g=false;1==g&&(ja(d.inputReports,n.m,a.D,a.v),ja(d.outputReports,n.s,a.m,a.g),ja(d.featureReports,n.l,a.s,a.u));}r(a,a.D);r(a,a.m);r(a,a.s);18==(c&18)&&(c&=-17);v(c);}else v(0);else v(0);}
...
class n{static g=l;static m={720928:0,720943:1,720929:2,720932:4,720903:5,589831:5,4288676023:20,4288676019:21,4288807055:8,4288807095:9,4288807009:9,4288807068:11,4288807091:13,4288807133:15,4279959745:7};static s={524311:0,524297:1,524312:3,524320:6,4288807132:17,4288807093:10,4288807070:14,4288806946:16,4288806996:18,4279959745:7};static l={4288807093:12,4288807055:19};constructor(){this.C=this.C.bind(this);this.l=this.device=null;this.D={};this.m={};this.s={};this.v={};this.g={};this.u={};this.B=
0;navigator.hid.addEventListener("disconnect",a=>{ka(this,a);});}C(a){let b=a.reportId;a=a.data;const e=new Uint8Array(a.byteLength);for(let c=0;c<a.byteLength;++c)e[c]=a.getUint8(c);b in this.v&&(r(this,`onInputReport id:${b} data:${e}`),ha(b,e,this.v,n.m,0));}}var v,ia;const x=new n;var qa=Object.assign({},l),y="",ra,sa;
...
A("onFree");A("onFullScreen");A("onMalloc");A("onRealloc");A("onRuntimeInitialized");A("postMainLoop");A("postRun");A("preInit");A("preMainLoop");A("preRun");A("preinitializedWebGLContext");A("preloadPlugins");A("print");A("printErr");A("setStatus");A("statusMessage");A("stderr");A("stdin");A("stdout");A("thisProgram");A("wasm");A("wasmBinary");A("websocket");A("fetchSettings");B("arguments","arguments_");B("thisProgram","thisProgram");C("undefined"==typeof l.memoryInitializerPrefixURL,"Module.memoryInitializerPrefixURL option was removed, use Module.locateFile instead");
C("undefined"==typeof l.pthreadMainPrefixURL,"Module.pthreadMainPrefixURL option was removed, use Module.locateFile instead");C("undefined"==typeof l.cdInitializerPrefixURL,"Module.cdInitializerPrefixURL option was removed, use Module.locateFile instead");C("undefined"==typeof l.filePackagePrefixURL,"Module.filePackagePrefixURL option was removed, use Module.locateFile instead");C("undefined"==typeof l.read,"Module.read option was removed");C("undefined"==typeof l.readAsync,"Module.readAsync option was removed (modify readAsync in JS)");
C("undefined"==typeof l.readBinary,"Module.readBinary option was removed (modify readBinary in JS)");C("undefined"==typeof l.setWindowTitle,"Module.setWindowTitle option was removed (modify emscripten_set_window_title in JS)");C("undefined"==typeof l.TOTAL_MEMORY,"Module.TOTAL_MEMORY has been renamed Module.INITIAL_MEMORY");B("asm","wasmExports");B("readAsync","readAsync");B("readBinary","readBinary");B("setWindowTitle","setWindowTitle");C(!ea,"node environment detected but not enabled at build time.  Add `node` to `-sENVIRONMENT` to enable.");
C(!fa,"shell environment detected but not enabled at build time.  Add `shell` to `-sENVIRONMENT` to enable.");B("wasmBinary","wasmBinary");"object"!=typeof WebAssembly&&z("no native wasm support detected");var va,wa=false;function C(a,b){a||E("Assertion failed"+(b?": "+b:""));}var xa,F,G,ya,H,I,za,Aa,Ba,Ca,Da=false,Ea=a=>a.startsWith("data:application/octet-stream;base64,"),ta=a=>a.startsWith("file://");
...
La("asm","Please use wasmExports instead");function Ma(a){Object.getOwnPropertyDescriptor(l,a)||Object.defineProperty(l,a,{configurable:true,get(){var b=`'${a}' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the Emscripten FAQ)`;Ja(a)&&(b+=". Alternatively, forcing filesystem support (-sFORCE_FILESYSTEM) can export this for you");E(b);}});}C(!l.STACK_SIZE,"STACK_SIZE can no longer be set at runtime.  Use -sSTACK_SIZE at link time");
C("undefined"!=typeof Int32Array&&"undefined"!==typeof Float64Array&&void 0!=Int32Array.prototype.subarray&&void 0!=Int32Array.prototype.set,"JS engine does not provide full typed array support");C(!l.wasmMemory,"Use of `wasmMemory` detected.  Use -sIMPORTED_MEMORY to define wasmMemory externally");C(!l.INITIAL_MEMORY,"Detected runtime INITIAL_MEMORY setting.  Use -sIMPORTED_MEMORY to define wasmMemory dynamically");var Na=[],Oa=[],Pa=[],L=0,M=null,N={},O=null;
function Qa(){L++;C(!N["wasm-instantiate"]);N["wasm-instantiate"]=1;null===O&&"undefined"!=typeof setInterval&&(O=setInterval(()=>{if(wa)clearInterval(O),O=null;else {var a=false,b;for(b in N)a||(a=true,z("still waiting on run dependencies:")),z(`dependency: ${b}`);a&&z("(end of list)");}},1E4));}function E(a){a="Aborted("+a+")";z(a);wa=true;a=new WebAssembly.RuntimeError(a);ba(a);throw a;}
...
function P(a,b){return (...e)=>{C(Da,`native function \`${a}\` called before runtime initialization`);var c=Q[a];C(c,`exported native function \`${a}\` not found`);C(e.length<=b,`native function \`${a}\` called with ${e.length} args but expects ${b}`);return c(...e)}}var Sa;async function Ta(a){try{var b=await ra(a);return new Uint8Array(b)}catch{}if(sa)a=sa(a);else throw "both async and sync fetching of the wasm failed";return a}
...
var J=a=>{C("number"===typeof a);return "0x"+(a>>>0).toString(16).padStart(8,"0")},K=a=>{K.A||(K.A={});K.A[a]||(K.A[a]=1,z(a));},R=a=>{if(null===a)return "null";var b=typeof a;return "object"===b||"array"===b||"function"===b?a.toString():""+a},Wa,S=a=>{for(var b="";F[a];)b+=Wa[F[a++]];return b},Xa={},Ya={},T;
...
65536>d?c+=String.fromCharCode(d):(d-=65536,c+=String.fromCharCode(55296|d>>10,56320|d&1023));}}else c+=String.fromCharCode(d);}return c},ib="undefined"!=typeof TextDecoder?new TextDecoder("utf-16le"):void 0,jb=(a,b)=>{C(0==a%2,"Pointer passed to UTF16ToString must be aligned to two bytes!");var e=a>>1;for(var c=e+b/2;!(e>=c)&&ya[e];)++e;e<<=1;if(32<e-a&&ib)return ib.decode(F.subarray(a,e));e="";for(c=0;!(c>=b/2);++c){var d=G[a+2*c>>1];if(0==d)break;e+=String.fromCharCode(d);}return e},kb=(a,b,e)=>{C(0==
b%2,"Pointer passed to stringToUTF16 must be aligned to two bytes!");C("number"==typeof e,"stringToUTF16(str, outPtr, maxBytesToWrite) is missing the third parameter that specifies the length of the output buffer!");e??=2147483647;if(2>e)return 0;e-=2;var c=b;e=e<2*a.length?e/2:a.length;for(var d=0;d<e;++d)G[b>>1]=a.charCodeAt(d),b+=2;G[b>>1]=0;return b-c},lb=a=>2*a.length,mb=(a,b)=>{C(0==a%4,"Pointer passed to UTF32ToString must be aligned to four bytes!");for(var e=0,c="";!(e>=b/4);){var d=H[a+
4*e>>2];if(0==d)break;++e;65536<=d?(d-=65536,c+=String.fromCharCode(55296|d>>10,56320|d&1023)):c+=String.fromCharCode(d);}return c},nb=(a,b,e)=>{C(0==b%4,"Pointer passed to stringToUTF32 must be aligned to four bytes!");C("number"==typeof e,"stringToUTF32(str, outPtr, maxBytesToWrite) is missing the third parameter that specifies the length of the output buffer!");e??=2147483647;if(4>e)return 0;var c=b;e=c+e-4;for(var d=0;d<a.length;++d){var g=a.charCodeAt(d);if(55296<=g&&57343>=g){var f=a.charCodeAt(++d);
g=65536+((g&1023)<<10)|f&1023;}H[b>>2]=g;b+=4;if(b+4>e)break}H[b>>2]=0;return b-c},ob=a=>{for(var b=0,e=0;e<a.length;++e){var c=a.charCodeAt(e);55296<=c&&57343>=c&&++e;b+=4;}return b},pb=[null,[],[]],W=[],X,w=a=>{var b=W[a];b||(a>=W.length&&(W.length=a+1),W[a]=b=X.get(a));C(X.get(a)==b,"JavaScript-side Wasm function table mirror is out of date!");return b},Y,qb=[],rb=Array(256),sb=0;256>sb;++sb)rb[sb]=String.fromCharCode(sb);Wa=rb;
T=l.BindingError=class extends Error{constructor(a){super(a);this.name="BindingError";}};l.InternalError=class extends Error{constructor(a){super(a);this.name="InternalError";}};V.push(0,1,void 0,1,null,1,true,1,false,1);C(10===V.length);l.count_emval_handles=()=>V.length/2-5-bb.length;
...
I[e>>2],d=e+4,g,f=d,h=0;h<=c;++h){var p=d+h;if(h==c||0==F[p]){var k=f;f=p-f;C("number"==typeof k,`UTF8ToString expects a number (got ${typeof k})`);k=k?hb(F,k,f):"";void 0===g?g=k:(g+=String.fromCharCode(0),g+=k);f=p+1;}}Z(e);return g},toWireType:function(e,c){c instanceof ArrayBuffer&&(c=new Uint8Array(c));var d="string"==typeof c;if(!(d||c instanceof Uint8Array||c instanceof Uint8ClampedArray||c instanceof Int8Array))throw new T("Cannot pass non-string to std::string");var g;if(d)for(var f=g=0;f<
c.length;++f){var h=c.charCodeAt(f);127>=h?g++:2047>=h?g+=2:55296<=h&&57343>=h?(g+=4,++f):g+=3;}else g=c.length;h=g;g=tb(4+h+1);f=g+4;I[g>>2]=h;if(d){if(h+=1,C("number"==typeof h,"stringToUTF8(str, outPtr, maxBytesToWrite) is missing the third parameter that specifies the length of the output buffer!"),d=f,f=F,C("string"===typeof c,`stringToUTF8Array expects a string (got ${typeof c})`),0<h){h=d+h-1;for(var p=0;p<c.length;++p){var k=c.charCodeAt(p);if(55296<=k&&57343>=k){var q=c.charCodeAt(++p);k=
...
fd_close:()=>{E("fd_close called without SYSCALLS_REQUIRE_FILESYSTEM");},fd_seek:function(){return 70},fd_write:(a,b,e,c)=>{for(var d=0,g=0;g<e;g++){var f=I[b>>2],h=I[b+4>>2];b+=8;for(var p=0;p<h;p++){var k=a,q=F[f+p],t=pb[k];C(t);0===q||10===q?((1===k?ua:z)(hb(t)),t.length=0):t.push(q);}d+=h;}I[c>>2]=d;return 0},platform_connect_headset:function(a){ma(x,a);},platform_disconnect_headset:function(){var a=x;v=void 0;a.device?(u(a,1,"Disconnecting Headset"),a.device.close(),a.device=null,a=true):a=false;return a},
...
(async function(){Qa();var a={env:ub,wasi_snapshot_preview1:ub};Sa??=l.locateFile?Ea("call_control_sdk.wasm")?"call_control_sdk.wasm":y+"call_control_sdk.wasm":(new URL("call_control_sdk.wasm",import.meta.url)).href;try{var b=await Va(a);C(l===l,"the Module object should not be replaced during async compilation - perhaps the order of HTML elements is wrong?");Q=b.instance.exports;va=Q.memory;C(va,"memory not found in wasm exports");var e=va.buffer;l.HEAP8=xa=new Int8Array(e);l.HEAP16=G=
new Int16Array(e);l.HEAPU8=F=new Uint8Array(e);l.HEAPU16=ya=new Uint16Array(e);l.HEAP32=H=new Int32Array(e);l.HEAPU32=I=new Uint32Array(e);l.HEAPF32=za=new Float32Array(e);l.HEAPF64=Ca=new Float64Array(e);l.HEAP64=Aa=new BigInt64Array(e);l.HEAPU64=Ba=new BigUint64Array(e);X=Q.__indirect_function_table;C(X,"table not found in wasm exports");Oa.unshift(Q.__wasm_call_ctors);L--;C(N["wasm-instantiate"]);delete N["wasm-instantiate"];0==L&&(null!==O&&(clearInterval(O),O=null),M&&(a=M,M=null,a()));return Q}catch(c){return ba(c),
Promise.reject(c)}})();l._connect_headset=P("connect_headset",1);l._disconnect_headset=P("disconnect_headset",0);l._set_call_state=P("set_call_state",1);l._set_mute_state=P("set_mute_state",1);l._register_event_handler=P("register_event_handler",1);var Z=l._free=P("free",1),tb=l._malloc=P("malloc",1),vb=()=>(vb=Q.emscripten_stack_init)(),Ga=()=>(Ga=Q.emscripten_stack_get_end)();
l.addFunction=(a,b)=>{C("undefined"!=typeof a);if(!Y){Y=new WeakMap;var e=X.length;if(Y)for(var c=0;c<0+e;c++){var d=w(c);d&&Y.set(d,c);}}if(e=Y.get(a)||0)return e;if(qb.length)e=qb.pop();else {try{X.grow(1);}catch(h){if(!(h instanceof RangeError))throw h;throw "Unable to grow wasm table. Set ALLOW_TABLE_GROWTH.";}e=X.length-1;}try{c=e,X.set(c,a),W[c]=X.get(c);}catch(h){if(!(h instanceof TypeError))throw h;C("undefined"!=typeof b,"Missing signature argument to addFunction: "+a);if("function"==typeof WebAssembly.Function){c=
WebAssembly.Function;d={i:"i32",j:"i64",f:"f32",d:"f64",e:"externref",p:"i32"};for(var g={parameters:[],results:"v"==b[0]?[]:[d[b[0]]]},f=1;f<b.length;++f)C(b[f]in d,"invalid signature char: "+b[f]),g.parameters.push(d[b[f]]);b=new c(g,a);}else {c=[1];d=b.slice(0,1);b=b.slice(1);g={i:127,p:127,j:126,f:125,d:124,e:111};c.push(96);f=b.length;C(16384>f);128>f?c.push(f):c.push(f%128|128,f>>7);for(f=0;f<b.length;++f)C(b[f]in g,"invalid signature char: "+b[f]),c.push(g[b[f]]);"v"==d?c.push(0):c.push(1,g[d]);
b=[0,97,115,109,1,0,0,0,1];d=c.length;C(16384>d);128>d?b.push(d):b.push(d%128|128,d>>7);b.push(...c);b.push(2,7,1,1,101,1,102,0,0,7,5,1,1,102,0,0);b=new WebAssembly.Module(new Uint8Array(b));b=(new WebAssembly.Instance(b,{e:{f:a}})).exports.f;}c=e;X.set(c,b);W[c]=X.get(c);}Y.set(a,e);return e};l.removeFunction=a=>{Y.delete(w(a));X.set(a,null);W[a]=X.get(a);qb.push(a);};
...
var wb;function xb(){if(0<L)M=xb;else {vb();var a=Ga();C(0==(a&3));0==a&&(a+=4);I[a>>2]=34821223;I[a+4>>2]=2310721022;for(I[0]=1668509029;0<Na.length;)Na.shift()(l);if(0<L)M=xb;else {C(!wb);wb=true;l.calledRun=true;if(!wa){C(!Da);Da=true;for(Fa();0<Oa.length;)Oa.shift()(l);aa(l);C(!l._main,'compiled without a main, but one is present. if you added it from JS, use Module["onRuntimeInitialized"]');for(Fa();0<Pa.length;)Pa.shift()(l);}Fa();}}}xb();moduleRtn=ca;
